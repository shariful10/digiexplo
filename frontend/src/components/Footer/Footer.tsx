					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-12">
						<div>
							...
							<p className="mt-5">
								...
								processes. Appropriately initiate cross-media infrastructures
						...
						<div className="flex flex-col gap-6">
							{!user && user === null && (
								<div>
									...
									<Link
										href={user ? "/vendor-request" : "/signup"}
										onClick={handleVendorRequestBtn}
									>
							...
							<div className="">
								<h4 className="text-2xl font-semibold mb-5">Follow us on</h4>
