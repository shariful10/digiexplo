				...
				{blogs.map(({ id, title, desc, author, category, bg_img }) => (
					...
					>
						<div className="mb-5 flex flex-col justify-between">
							...
							<p className="text-black">{desc.slice(0, 100)}...</p>
						</div>
						<Link
							href={`/blogs/${id}`}
